...
const ContactForm: React.FC = () => {
  ...
  const inputClass = "w-full px-4 py-3 bg-[#1f2324]/80 border border-[#2d3233] rounded-lg text-white font-normal font-['Inter'] focus:ring-2 focus:ring-[#e7ab09] focus:border-[#e7ab09] outline-none transition-all duration-200 placeholder-gray-500 text-[16px]";
  const labelClass = "block text-[14px] font-medium text-gray-200 mb-1.5 font-['Inter']";

  return (
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label htmlFor="name" className={labelClass}>Full Name <span className="text-[#e7ab09]">*</span></label>
      ...
      <div>
        <label htmlFor="email" className={labelClass}>Email Address <span className="text-[#e7ab09]">*</span></label>
      ...
      <div>
        <label htmlFor="message" className={labelClass}>Your Message / Event Details <span className="text-[#e7ab09]">*</span></label>
      ...
      <div>
        <button
          type="submit"
          className="w-full bg-[#e7ab09] hover:bg-[#c79608] text-black font-['Inter'] font-semibold py-3.5 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#e7ab09] focus:ring-opacity-75 text-[16px]"
        >
          SEND YOUR REQUEST
        </button>
      </div>
